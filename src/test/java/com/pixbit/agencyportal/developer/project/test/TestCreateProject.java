package com.pixbit.agencyportal.developer.project.test;

import org.testng.annotations.Test;
import com.pixbit.agencyportal.globalfiles.GlobalData;
import com.pixbit.agencyportal.pages.HomePage;
import com.pixbit.agencyportal.pages.ProjectCreatePage;
import com.pixbit.agencyportal.pages.ProjectPage;
import com.pixbit.agencyportal.pages.ProjectShowPage;
...
public class TestCreateProject extends GlobalData {
    ...
    public void singlePhaseReadyYesPostHandover1(HashMap<String, String> input)
        ...
        ProjectCreatePage.selectDeveloperAndSelectStatus(input.get("project_developer"), input.get("project_status"));
