...
public class CreateProject extends GlobalData {
	...
	// Create project as "Ready" Unit with "Yes" in Post Handover
	// 1 Phase, 1 Payment Plan and 1 Payment shedule
	@Test(dataProvider = "projectCreateData_1", enabled = false)
	public void singlePhaseReadyYesPosthandover_1(HashMap<String, String> input)
		...
		ProjectShowPage.verifyProjectReadyUnitYesPostHandover(input.get("project_developer"),
	...
	// Create Project with Ready unit and Under construction
	// 2 phases first phase 2 payment plan first plan 3 shedules and second plan two
	// shedules
	// second phase 2 payment plan first plan contain 2 shedules and second plan
	// contains 2 shedule
	...
	/*
	 * @Test public void
	 * createProject_TwoPhase_TwoPaymentPlan_TwoShedules(HashMap<String, String>
	 * input) throws InterruptedException { HomePage HomePage =
	 * LoginPage.login(input.get("email_id"), input.get("password")); ProjectPage
	 * ProjectPage = HomePage.openProjects(); ProjectCreatePage ProjectCreatePage =
	 * ProjectPage.openAddProject();
	 * ProjectCreatePage.selectDeveloperAndStatus(input.get("project_developer"),
	 * input.get("project_status"));
	 * ProjectCreatePage.enterProjectDetails(input.get("project_name"),
	 * input.get("project_number"), input.get("project_description"),
	 * input.get("escrow_number"));
	 * ProjectCreatePage.readyYesPhaseAndReadyNoPhase(input.get("phase_name_1"),
	 * input.get("noc_document"), input.get("payment_name_1"), input.get("date_1"),
	 * input.get("particular_value_1"), input.get("period_1"),
	 * input.get("booking_amount_1"), input.get("date_2"),
	 * input.get("particular_value_2"), input.get("period_2"),
	 * input.get("booking_amount_2"), input.get("date_3"),
	 * input.get("particular_value_3"), input.get("period_3"),
	 * input.get("booking_amount_3"), input.get("date_4"),
	 * input.get("particular_value_4"), input.get("booking_amount_4")); }
	 */
